...
mkdir -p ${TMP_BASE_DIR}/node5
mkdir -p ${TMP_BASE_DIR}/node6
mkdir -p ${TMP_BASE_DIR}/node7
mkdir -p ${TMP_BASE_DIR}/node8
mkdir -p ${TMP_BASE_DIR}/node9
...
ssh-keygen -b 2048 -t rsa -f ${TMP_BASE_DIR}/node5/id_rsa    -C ubuntu@node5  -q -N ""
ssh-keygen -b 2048 -t rsa -f ${TMP_BASE_DIR}/node6/id_rsa    -C ubuntu@node6  -q -N ""
ssh-keygen -b 2048 -t rsa -f ${TMP_BASE_DIR}/node7/id_rsa    -C ubuntu@node7  -q -N ""
ssh-keygen -b 2048 -t rsa -f ${TMP_BASE_DIR}/node8/id_rsa    -C ubuntu@node8  -q -N ""
ssh-keygen -b 2048 -t rsa -f ${TMP_BASE_DIR}/node9/id_rsa    -C ubuntu@node9  -q -N ""
